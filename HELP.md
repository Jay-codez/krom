...
* [Spring Web Services](https://docs.spring.io/spring-boot/docs/3.3.0-M3/reference/htmlsingle/index.html#io.webservices)
* [Spring Data MongoDB](https://docs.spring.io/spring-boot/docs/3.3.0-M3/reference/htmlsingle/index.html#data.nosql.mongodb)
